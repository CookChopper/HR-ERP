  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img v-imagerror="require('@/assets/common/bigUserHeader.png')" :src="staffPhoto">
          </div>
    ...
    <el-row type="flex" justify="space-between">
      ...
      <el-col :span="11">
        <el-card class="box-card">
          ...
          <div class="sideNav">
            <el-button class="sideBtn" @click="showApplyDialog = true">加班离职</el-button>
            <officeApply :show-dialog.sync="showApplyDialog" />
            <el-button class="sideBtn">请假调休</el-button>
            <el-button class="sideBtn" @click="$router.push('/approvals')">审批列表</el-button>
            <el-button class="sideBtn" @click="$router.push('/approvals/info')">我的信息</el-button>
          </div>
        </el-card>
...
import WorkCalendar from './components/word-calendar.vue'
import Radar from './components/radar.vue'
import officeApply from './components/officeApply.vue'
export default {
  name: 'Dashboard',
  computed: {
    ...mapGetters([
  ...
  components: {
    WorkCalendar, Radar, officeApply
  },
  data() {
    return {
