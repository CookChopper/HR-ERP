...
<script>
import { getUserDetailById, getUserPersonlById, saveUserPersonl } from '@/api/user'
...
export default {
  ...
  methods: {
    ...
    async getUserInfo() {
      ...
      const personData = await getUserPersonlById(this.userId)
